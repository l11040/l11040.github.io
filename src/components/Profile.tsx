...
export default function Profile({ avatars_URL, name, location, job, github_URL, instagram_URL, desc }: IInfo) {
    return (
        <Card>
            <div className="pb-6">
                ...
                <div className="mt-2 text-center">
                    ...
                    <h3 className="mb-1 text-2xl font-bold leading-normal text-gray-700 dark:text-gray-300 ">
                        <span className="text-transparent bg-clip-text bg-gradient-to-tr from-[#FF8660] to-[#8000FF]">{name}</span>
                    </h3>
                    <div className="flex flex-row justify-center w-full mx-auto space-x-2 text-center">
                        ...
                        <div className="text-lg font-bold tracking-wide text-gray-600 dark:text-gray-300 font-mono">{location}</div>
                    </div>
                    <div className="text-sm font-bold tracking-wide text-gray-600 dark:text-gray-300 font-mono">{job}</div>
                    <div className="w-full text-center">
                        <div className="flex justify-center pt-8 pb-0 lg:pt-4">
                            <div className="flex space-x-2">
                                <a className="p-1 -m-1 text-gray-400 hover:text-amber-500 focus:outline-none focus-visible:ring-2 ring-primary" href={github_URL} rel="noopener" aria-label="Ariel Cerda on Github" target="_blank">
